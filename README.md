...
Save this as dashboard.yaml

```
curl https://raw.githubusercontent.com/kubernetes/dashboard/v1.10.1/src/deploy/recommended/kubernetes-dashboard-arm.yaml
```
...
192.168.2.10 is the ip address of the master node.
